...
/**
 * Ordenamiento por heap — complejidad Θ(n log n) todos los casos, O(1)
 * espacio.
 * Localidad de caché inferior a MergeSort por accesos no secuenciales al
 * heap.
 */
...
for (int i = n - 1; i > 0; i--) { 
int tmp = a[0]; a[0] = a[i]; a[i] = tmp;  // swap raíz con último 
siftDown(a, i, 0); 
} 
return a; 
}
